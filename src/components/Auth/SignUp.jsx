      ...
      <section className="p-10 w-full  flex-center bg-[#ffe]">
        <div className="shadow-md w-full min-h-[80vh] rounded-xl bg-white flex justify-center itmes-center gap-5 flex-wrap">
          <div className="rigth bg-theme w-[450px] h-[80vh] text-center flex justify-center flex-col overflow-hidden">
            ...
            <h1 className="text-center text-4xl"><b>CAFELORDS</b></h1>
          </div>
          <div className="left rounded w-[480px] h-[80vh] p-5 flex flex-col">
            ...
            <form className="w-full mb-5" onSubmit={handleSignUp}>
              ...
              <div className={`w-full justify-between items-center bg-white px-3 flex  h-[50px] gap-3 rounded mt-5 text-xl px-3 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-yellow-400 border-2 border-yellow-300 transition-all duration-200`}>
                <RiLockPasswordFill />
                <input
                  className="w-full"
                  type="password"
           ...
           {error && <p className="text-red-500">{error}</p>}
              <div className="flex gap-3 text-xl mt-5 px-3">
                ...
                <p>by continuing you accept our privacy policy and term & conditiom</p>
              </div>
             <input type="submit" value='Submit' className="mt-10 bg-blue-700 w-full h-[50px] rounded-lg text-center text-xl text-white" />
            </form>
            <p className="text-xl text-center mb-5">Already have an account?  <span className="text-blue-700"><Link to='/login'>Login</Link></span></p>
