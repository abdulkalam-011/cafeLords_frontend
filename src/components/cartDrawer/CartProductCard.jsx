    ...
    >
      <div className="flex items-center gap-6  w-[80%]">
        ...
        <div className="h-full py-3">
          ...
          <p className="text-xl font-semibold text-green-500 mt-5">
            {item.discount_percentage}% OFF
          </p>
        </div>
      </div>
      <span className="text-lg font-bold w-[20%] relative overflow-hidden flex items-center justify-center">
        ₹{item.final_price * userItem.quantity}{" "}
        <button
          className="px-3 py-2 rounded absolute right-0 top-0 text-red-700"
