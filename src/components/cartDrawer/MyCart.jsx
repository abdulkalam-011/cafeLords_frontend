  ...
  return (
    <section className="flex flex-wrap p-0 sm:p-15 bg-gray-100 gap-4">
      <div className="left w-[70%] min-w-[500px] bg-white min-h-[10vh] relative  p-4 rounded px-5 shadow-lg ">
        ...
        <button
          className="bg-red-700 text-white font-md px-3 py-2 rounded mt-4 text-xl"
      ...
      <div className="right rounded w-[20%] bg-white h-fit px-3 py-2 shadow-lg min-w-[300px]">
        <h1 className="text-lg px-2 py-2 border-b-2 font-bold border-gray-300">
          TOTAL
        </h1>
        ...
        <button
          className="w-full px-3 py-2 bg-green-600 mt-5 text-md text-white rounded font-semibold"
