...
const ProductPage = () => {
  ...
  const handleBuy = useCallback((e) => {
    try {
      ...
      toast.error(
        "server failed :unable to add item to cart ! Please try again",
        {
          position: "bottom-center",
          autoClose: 3000,
          hideProgressBar: false,
  ...
  return (
    <>
      {item ? (
        <div className="w-full h-[100vh] bg-theme-dark flex items-center justify-center p-8 ">
          <div className="w-[90%] h-[95%] rounded flex flex-wrap bg-[#111] overflow-auto shadow-lg">
            <div className="w-[40%] h-full">
              <img
                className="w-full h-full fit-cover rounded shadow-md"
                src={item.image}
                alt=""
              />
            </div>
            <div className="w-[60%] h-full p-8">
              ...
              <div className="flex justify-between items-center mt-5 text-xl px-8 pb-4 py-3 rounded-3xl">
                ...
                <div className="flex justify-between items-center ">
                  <button
                    className="bg-gray-600 rounded w-8 h-8 text-white flex items-center justify-center font-semibold "
                    onClick={() => {
                  ...
                  <p className="font-bold text-3xl mx-5 flex justify-center items-center text-center bg-white text-black rounded-md px-5 py-2">
                    {Quantity}
                  </p>
                  <button
                    className="bg-gray-600 mr-4 rounded w-8 h-8 text-white flex items-center justify-center font-semibold "
              ...
              <div className="flex gap-8 items-center justify-end mt-0 text-white">
                <button
                  ...
                  className="px-8 py-5 bg-green-400 text-2xl w-[40%] font-bold   hover:opacity-75 rounded-xl"
                >
                  Add To Cart{" "}
                </button>
                <button
                  onClick={handleBuy}
                  className="px-8 py-5 bg-yellow-500 w-[60%] text-2xl font-bold rounded-xl hover:opacity-75 cursor-pointer"
                >
                  Buy Now
                </button>
              </div>
        ...
        <div className="w-full h-[90vh] bg-theme flex items-center justify-center">
